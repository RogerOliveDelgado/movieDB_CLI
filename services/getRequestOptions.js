...
export const API_PATH = {
  ...
  popularMovies: (page) => `/3/movie/popular?page=${page}&api_key=${process.env.API_KEY}`,
  nowPlayingMovies: (page) => `/3/movie/now_playing?page=${page}&api_key=${process.env.API_KEY}`,
  singleMovie: (id) => `/3/movie/${id}?api_key=${process.env.API_KEY}`,
  singleMovieReviews: (id) => `/3/movie/${id}/reviews?api_key=${process.env.API_KEY}`,
};
